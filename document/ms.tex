...
\title{IGRINS spectra of the outbursting source \name}
...
\name is an outbursting source.  In this short research note we provide the IGRINS spectrum of \name.  
...
\input{tables/tbl_linewidths.tex}
